...
namespace Autowatchers.FuncTests.Factories;

public class AppFactory : WebApplicationFactory<Server.Program>
{
    private bool _disposed;
    private IHost? _host;
    private readonly Uri _baseUrl = new("http://localhost:8080");
